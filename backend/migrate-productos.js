...
const productos = [
  ...
  // PALITOS
  { nombre: 'Palito Bombón x 1', precio_unitario: 1000, categoria: 'PALITOS' },
  { nombre: 'Palito Bombón x 10', precio_unitario: 7000, categoria: 'PALITOS' },
  { nombre: 'Palito Bombón x 20', precio_unitario: 14000, categoria: 'PALITOS' },
  { nombre: 'Palito Cremoso x 1', precio_unitario: 900, categoria: 'PALITOS' },
  { nombre: 'Palito Cremoso x 10', precio_unitario: 5500, categoria: 'PALITOS' },
  { nombre: 'Palito Cremoso x 20', precio_unitario: 11000, categoria: 'PALITOS' },
  { nombre: 'Palito Frutal x 1', precio_unitario: 800, categoria: 'PALITOS' },
  { nombre: 'Palito Frutal x 10', precio_unitario: 5000, categoria: 'PALITOS' },
  { nombre: 'Palito Frutal x 20', precio_unitario: 10000, categoria: 'PALITOS' },
  // TORTAS
  ...
  { nombre: 'Blister x 3', precio_unitario: 1000, categoria: 'EXTRAS' },
  { nombre: 'Topping x 1', precio_unitario: 550, categoria: 'EXTRAS' },
  { nombre: 'Topping x 2', precio_unitario: 1000, categoria: 'EXTRAS' },
  ...
  // CHOCOLATES
  { nombre: 'Block 38gr', precio_unitario: 2000, categoria: 'CHOCOLATES' },
  { nombre: 'Block 110gr', precio_unitario: 5000, categoria: 'CHOCOLATES' },
  { nombre: 'Block 170gr', precio_unitario: 8900, categoria: 'CHOCOLATES' },
  ...
  { nombre: 'Agua 2 lt', precio_unitario: 2000, categoria: 'BEBIDAS' },
  // PROMOCIONES
